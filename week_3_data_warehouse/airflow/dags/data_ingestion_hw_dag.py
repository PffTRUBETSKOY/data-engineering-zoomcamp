...
OUTPUT_FILE_TEMPLATE = 'yellow_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.csv'
...
with DAG(    
    dag_id="data_ingestion_yellow_dag",
    ...
    cleanup_dataset_task = BashOperator(
        ...
        bash_command=f"rm {AIRFLOW_HOME}/{OUTPUT_FILE_TEMPLATE} {AIRFLOW_HOME}/{PARQUET_FILE_TEMPLATE}"
    )

    download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >>  cleanup_dataset_task