...
OUTPUT_FILE_TEMPLATE = 'output_fhv_{{ execution_date.strftime(\'%Y-%m\') }}.csv'
PARQUET_FILE_TEMPLATE = 'output_fhv_{{ execution_date.strftime(\'%Y-%m\') }}.parquet'
...
with DAG(    
    dag_id="data_ingestion_taxi_dag",
